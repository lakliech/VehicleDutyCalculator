                ...
                {!isLoading && !isAuthenticated && (
                  <Alert className="mb-6 border-orange-200 bg-orange-50">
                    ...
                    <AlertDescription className="text-orange-700">
                      You need to be logged in to create a car listing. Please choose your preferred sign-in method to continue.
                      ...
                      <div className="flex items-center my-4">
                        ...
                        <span className="px-3 text-sm text-orange-600">or</span>
                        <div className="flex-1 border-t border-orange-300"></div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <Button 
                          ...
                          variant="outline"
                          className="border-orange-300 text-orange-700 hover:bg-orange-100 flex items-center justify-center"
                          size="sm"
                        >
