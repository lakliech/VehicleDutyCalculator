...
import { Database, LogOut, List, Heart, MessageCircle, User, Car, Search, Settings, Activity, Plus, Lock, Mail, Ban, Shield, RefreshCw, Download } from "lucide-react";
...
function UserProfileModal({ userId, open, onClose }: { userId: string; open: boolean; onClose: () => void }) {
