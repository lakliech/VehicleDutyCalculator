                    ...
                    {filters.maxPrice < 10000000 && (
                      <div className="mt-4">
                        <p className="text-sm text-gray-500 mb-3">
                          No cars found under KES {filters.maxPrice.toLocaleString()}
                        </p>
                        <Button 
                          variant="outline" 
                          onClick={() => {
                            setFilters(prev => ({ ...prev, maxPrice: filters.maxPrice + 100000 }));
                            toast({ 
                              title: "Price range adjusted", 
                              description: `Now showing cars under KES ${(filters.maxPrice + 100000).toLocaleString()}`
                            });
                          }}
                        >
                          Show cars under KES {(filters.maxPrice + 100000).toLocaleString()}
                        </Button>
                      </div>
                    )}
                  </div>
